...
class ManageDisplay:
    ...
    async def confirm_delete(
        self, email: Dict[str, Any], permanent: bool = False
    ) -> bool:
    ...
    async def confirm_move(
        self, email: Dict[str, Any], from_folder: str, to_folder: str
    ) -> bool:
    ...
    def show_moved(self, email_id: str, from_folder: str, to_folder: str) -> None:
        ...
        self.panel.show_success(
            f"Email {email_id} moved from {from_folder} to {to_folder}"
        )
