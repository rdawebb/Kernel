...
class TestComposeEmailWorkflow:
    ...
    def test_compose_email_basic_workflow(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_invalid_recipient(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
...
class TestComposeEmailValidation:
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_empty_subject_confirm(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_empty_subject_reject(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_empty_body_confirm(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
...
class TestComposeSendActions:
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_send_now(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
...
class TestComposeMultilineBody:
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_multiline_body(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_body_with_empty_lines(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
...
class TestComposeErrorHandling:
    ...
    @patch("src.ui.composer.show_draft_saved")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_keyboard_interrupt(
        self, mock_prompt_details, mock_show_draft, mock_save_draft
    ):
    ...
    @patch("src.ui.composer.show_email_preview")
    @patch("src.ui.composer.prompt_email_details")
    def test_compose_email_send_failure(
        self,
        mock_prompt_details,
        mock_show_preview,
        mock_confirm,
